...
try:
    APP_ID = config("11321821", cast=int)
    API_HASH = config("bbf63cf902c2548c31963ccd88c4c6f7")
    BOT_TOKEN = config("5615063323:AAHzWuekv-wIvLHRJo3cOcAhj1daMZxsqEI")
    DEV = 1287276743
    OWNER = config("5665936025")
